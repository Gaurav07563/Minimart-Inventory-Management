...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:	#0000A0;"><center>MINI MART</center></font>
<div id="mainmain">



<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i><br> Sales</a>               
<a href="profile.php"><i class="icon-group icon-2x"></i><br> Profile</a> 
...
<a href="employee.php"><i class="icon-group icon-2x"></i><br> Employee</a> 
<a href="minimart.php"><i class="icon-group icon-2x"></i><br> Mini Mart</a> 
<a href="profile.php"><i class="icon-group icon-2x"></i><br> Profile</a> 
<a href="../index.php"><font color="red"><i class="icon-off icon-2x"></i></font><br> Logout</a> 
<?php
}
