...
<span>GSTIN : </span><input type="text" style="width:265px; height:30px;" name="gstin" /><br>
...
<span> Supplied : </span><textarea style="width:265px; height:80px;" name="note" /></textarea><br>
